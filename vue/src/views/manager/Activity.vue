  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="userName" label="活动创建人"></el-table-column>
        <el-table-column prop="num" label="活动规模"></el-table-column>
    ...
    <el-dialog title="活动" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="活动名称" prop="name">
          <el-input v-model="form.name" placeholder="活动名称"></el-input>
        </el-form-item>
        <el-form-item label="活动介绍" prop="introduce">
          <el-input v-model="form.introduce" placeholder="活动介绍"></el-input>
        </el-form-item>
        ...
        <el-form-item label="活动创建人" prop="userId">
          <el-input v-model="form.userId" placeholder="活动创建人"></el-input>
        </el-form-item>
        <el-form-item label="活动规模" prop="num">
          <el-input v-model="form.num" placeholder="活动规模"></el-input>
        </el-form-item>
        <el-form-item label="活动时间" prop="time">
          <el-input v-model="form.time" placeholder="活动时间"></el-input>
        </el-form-item>
        <el-form-item prop="typeId" label="所属类别">
          <el-select v-model="form.type" placeholder="请选择行业" style="width: 100%">
            <el-option v-for="item in TypeData" :label="item.name" :value="item.text" :key="item.id"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
