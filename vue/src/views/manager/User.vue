  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="introduce" label="用户介绍"></el-table-column>
        ...
        <el-table-column prop="status" label="禁用状态"></el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="用户介绍" prop="introduce">
          <el-input v-model="form.introduce" placeholder="用户介绍"></el-input>
        </el-form-item>
        ...
        <el-form-item label="禁用状态" prop="status">
          <el-input v-model="form.status" placeholder="禁用状态"></el-input>
        </el-form-item>
        <el-form-item label="最后登录时间" prop="lasttime">
          <el-input v-model="form.lasttime" placeholder="最后登录时间"></el-input>
        </el-form-item>
      </el-form>
