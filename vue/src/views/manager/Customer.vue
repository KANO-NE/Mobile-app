<template>
  <div>
    ...
    <div class="operation">
      <el-button type="primary" plain @click="handleAdd">回复聊天</el-button>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="content" label="聊天内容"></el-table-column>
    ...
    <el-dialog title="客服聊天" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="用户编号" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入用户编号"></el-input>
        </el-form-item>
        <el-form-item label="聊天内容" prop="content">
          <el-input v-model="form.content" placeholder="请输入聊天内容"></el-input>
        </el-form-item>
        <el-form-item label="接收人" prop="acceptId">
          <el-input v-model="form.acceptId" placeholder="请输入接收编号(同用户编号)"></el-input>
        </el-form-item>
