<template>
  <div>
    ...
    <el-dialog title="海报" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="标题" prop="title">
          <el-input v-model="form.title" placeholder="标题"></el-input>
        </el-form-item>
<!--        <el-form-item label="图片地址" prop="img">-->
<!--          <el-input v-model="form.img" placeholder="图片地址"></el-input>-->
<!--        </el-form-item>-->
        ...
        <el-form-item label="跳转地址" prop="url">
          <el-input v-model="form.url" placeholder="跳转地址"></el-input>
        </el-form-item>
        <el-form-item label="发布者" prop="username">
          <el-input v-model="form.username" placeholder="发布者"></el-input>
        </el-form-item>
